...
RUN git clone https://github.com/freexian/shim-review.git
WORKDIR /shim-review
RUN git checkout freexian-shim-16.1-debian-11
WORKDIR /
...
RUN git clone https://salsa.debian.org/lts-team/packages/shim.git
WORKDIR /shim
RUN git checkout bullseye/updates
